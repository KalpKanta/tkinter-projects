...
def win():
    ...
    for i in range(9):
        if nbv[winc[i](0)] == playerS and nbv[winc[i](1)] == playerS and nbv[winc[i](2)] == playerS:
            tkinter.messagebox.showinfo("Player Won!", "You have won the game!")
        if nbv[winc[i](0)] == computerS and nbv[winc[i](1)] == computerS and nbv[winc[i](2)] == computerS:
